...
})({"feiZq":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "b29080a5e163334d";
"use strict";
...
},{}],"jwlwA":[function(require,module,exports) {
...
var _particle = require("./entities/Particle");
var _player = require("./entities/Player");
var _projectile = require("./entities/Projectile");
...
const BIG_SCORE = document.querySelector("#bigScore");
...
let animationID;
let points = 0;
let player = new (0, _player.Player)({
    x: X,
    y: Y,
    radius: 10,
    color: "white"
...
const spawnEnemies = ()=>{
    setInterval(()=>{
        ...
        enemies.push(new (0, _enemy.Enemy)({
            x,
            y,
            radius,
            color,
...
const animate = ()=>{
    ...
    projectiles.forEach((projectile, pIndex)=>{
        projectile.update();
        if (projectile.x + projectile.radius < 0 || projectile.x - projectile.radius > CANVAS.width || projectile.y + projectile.radius < 0 || projectile.y - projectile.radius > CANVAS.height) setTimeout(()=>{
    ...
    enemies.forEach((enemy, eIndex)=>{
        ...
        projectiles.forEach((projectile, pIndex)=>{
            ...
            if (dist - enemy.radius - projectile.radius < 1) {
                ...
                SCORE.innerHTML = points.toString();
                // Explosion
                for(let i = 0; i < enemy.radius * 2; i++)particles.push(new (0, _particle.Particle)({
                    x: projectile.x,
                    y: projectile.y,
...
addEventListener("click", (event)=>{
    ...
    projectiles.push(new (0, _projectile.Projectile)({
        x: CANVAS.width / 2,
        y: CANVAS.height / 2,
        radius: 5,
        color: "white",
...
},{"gsap":"fPSuC","./entities/Enemy":"4CnlN","@parcel/transformer-js/src/esmodule-helpers.js":"7Rzro","./entities/Particle":"cY5DA","./entities/Player":"fCJUu","./entities/Projectile":"5ZjQd"}],"fPSuC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./gsap-core.js":"05eeC","./CSSPlugin.js":"l02JQ","@parcel/transformer-js/src/esmodule-helpers.js":"7Rzro"}],"05eeC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"7Rzro"}],"4CnlN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Enemy {
    ...
    draw() {
        (0, _script.CONTEXT).beginPath();
        (0, _script.CONTEXT).arc(this.x, this.y, this.radius, 0, Math.PI * 2, false);
        (0, _script.CONTEXT).fillStyle = this.color;
        (0, _script.CONTEXT).fill();
    }
    update() {
        this.draw();
...
},{"../script":"jwlwA","@parcel/transformer-js/src/esmodule-helpers.js":"7Rzro"}],"cY5DA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Particle {
    ...
    draw() {
        (0, _script.CONTEXT).save();
        (0, _script.CONTEXT).globalAlpha = this.alpha;
        (0, _script.CONTEXT).beginPath();
        (0, _script.CONTEXT).arc(this.x, this.y, this.radius, 0, Math.PI * 2, false);
        (0, _script.CONTEXT).fillStyle = this.color;
        (0, _script.CONTEXT).fill();
        (0, _script.CONTEXT).restore();
    }
    update() {
        this.draw();
        this.velocity.x *= (0, _script.FRICTION);
        this.velocity.y *= (0, _script.FRICTION);
        this.x = this.x + this.velocity.x;
        this.y = this.y + this.velocity.y;
        this.alpha -= 0.01;
    }
...
},{"../script":"jwlwA","@parcel/transformer-js/src/esmodule-helpers.js":"7Rzro"}],"fCJUu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../script":"jwlwA","@parcel/transformer-js/src/esmodule-helpers.js":"7Rzro"}],"5ZjQd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../script":"jwlwA","@parcel/transformer-js/src/esmodule-helpers.js":"7Rzro"}]},["feiZq","jwlwA"], "jwlwA", "parcelRequire94c2")

//# sourceMappingURL=index.e163334d.js.map
